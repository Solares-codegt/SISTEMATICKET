<%@ Page Title="" Language="C#" MasterPageFile="~/CONTROLADOR.Master" AutoEventWireup="true" CodeBehind="RECUPERACION.aspx.cs" Inherits="SOPORTE_TECNICO_TICKER.RECUPERACION" %>
...
<div class=" row col-md-3">
  <div class="mb-3 from-group" >
    <label for="lblnombreUsuario"  class="label  text-warning">USUARIO </label>			
      <asp:TextBox ID="TextBox1" class="form-control"  placeholder="INGRESE USUARIO"  runat="server"></asp:TextBox>
...
<div class=" row col-md-3">
  <div class="mb-3 from-group" >
    <label for="lblnombreUsuario"  class="label  text-warning">CORREO ELECTRONICO </label>			
      <asp:TextBox ID="TextBox3" class="form-control"  placeholder="INGRESE SU PASSWORD"  runat="server"></asp:TextBox>
...
<div class=" row col-md-3">
  <div class="mb-3 from-group" >
    <label for="lblnombreUsuario"  class="label  text-warning">PASSWORD DE RECUPERACION </label>			
      <asp:TextBox ID="TextBox2" class="form-control"  placeholder="INGRESE SU PASSWORD"  runat="server"></asp:TextBox>
