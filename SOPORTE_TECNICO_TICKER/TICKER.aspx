<%@ Page Title="" Language="C#" MasterPageFile="~/CONTROLADOR.Master" AutoEventWireup="true" CodeBehind="TICKER.aspx.cs" Inherits="SOPORTE_TECNICO_TICKER.TICKERaspx" %>
...
<body style="background-color:#49B39D">
    ...
    <script>
        ...
        window.alert("ANTES DE GENERAR SU TICKER PORFAVOR INICIE SESION");
    </script>
...
;
   padding:99px;
         ...
         <center>   
                ...
                <asp:Label ID="Label1"  CSSCLASS="col-3 col-form-label" runat="server" Text="NO DE TICKER" BackColor="BLACK"></asp:Label>  

                      <div class="col-8 col-md-4 ">                
                          <asp:TextBox tipe="text" ID="txtcod" placeHolder="NO TICKER"   runat="server"></asp:TextBox>  
   ...
   <asp:Button ID="Button1" runat="server"  CSSCLASS="btn form-control btn-info"  Text="GENERARTICKER" />
    
            </div>
            <div class="col-8 col-md-6">
             <asp:Button ID="Button2" runat="server"  CSSCLASS="btn form-control btn-info" OnClick="Button2_Click"  Text="REGISTRARSE" />
